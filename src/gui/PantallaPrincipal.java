...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    // Se define las cabeceras de las columnas
    dtm.setColumnIdentifiers(new String[]{"Nombre", "Apellidos", "Fecha Alta", "Provincia"});
    
    // Se asigna este modelo a la tabla creada en el diseño
    ...
    // Se añade una nueva fila usando el método helper creado en el dto
